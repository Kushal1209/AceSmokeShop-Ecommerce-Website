...
function CardChange() {
    ...
    if (cardNumber.length > 16) {
        document.getElementById('cardInput').value = cardNumber.substring(0, 15);
        document.getElementById('cardInput').text = cardNumber.substring(0, 15);
        document.getElementById('cardInput').textContent = cardNumber.substring(0, 15);
        document.getElementById('cardInput').val = cardNumber.substring(0, 15);
    }
}
